 ...
 * Copyright (c) Anders Riutta and contributors
 * Licensed under the BSD-2-Clause License (per the package manifest;
 * note: BSD-2-Clause, not MIT). Vendored unmodified from the npm dist build.
 */
// svg-pan-zoom v3.6.2
// https://github.com/bumbu/svg-pan-zoom
